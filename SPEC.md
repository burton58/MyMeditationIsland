...
| 4. Aug. 2026 | **Mudra entfällt auch auf der Abschluss-Seite** ("Entferne Mudra bei den Meditationen") — die Karte "Brauchst du noch etwas?" bietet nur noch das Mantra an. Die `MUDRAS`-Liste bleibt in der Datei, sie gehört zum deaktivierten Begleiter (§6a); entfernt sind nur `#needMudraBtn`, `#mudraBox`, `zeigeMudra()` und die `.mudra-card`-Regeln. | §3.5 |
