...
| 4. Aug. 2026 | **ENTWURF (noch nicht endgültig entschieden): "Deine Lieblingsmeditationen" auf der Startseite probeweise durch "Dein Fortschritt" ersetzt.** Christine hatte beim Prüfen der Startseite bemerkt, dass (1) "Dein heutiger Fokus" und "Deine Lieblingsmeditationen" fast gleich aussehen, obwohl nur die zweite Reihe einen Play-Knopf hat, und (2) der Name "Lieblingsmeditationen" mit den echten Stern-Favoriten verwechselt wird ("eigentlich heissen sie deine Favorites"). Auf die Frage, ob Favoriten, heutiger Fokus, beides oder keines gezeigt werden soll, wurde "Dein Fortschritt" (dieselbe Zahlenreihe wie auf "Mein Weg") als Alternative zum Test eingebaut, sichtbar per Screenshot. `renderLieblinge()` ist absichtlich noch nicht gelöscht, solange offen ist, ob der Fortschritt bleibt. | §3.3 |
