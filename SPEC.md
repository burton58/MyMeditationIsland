...
1. **Oben (Kopf, ~20–28 % Höhe):** Logo (52px), darunter der Name **"My Meditation Island"** als Serif-Überschrift (2.5rem, auf schmalen Geräten zweizeilig) und die Subheadline **"Meditationen auf Schweizerdeutsch"** (fest, einzeilig) Der Name ist bewusst das Grösste: So war es gewünscht, und die Marke soll sich einprägen. Die Chips mit Emoji sind wieder entfallen; die Dauer steht klein unter dem Knopf.
...
3. **Unten (Handlung), bewusst tief gesetzt:** goldene Taste **"7 Tage gratis starten"** (Nutzen statt Ort — der frühere Text "Meine Insel betreten" beschrieb einen Ort, nicht den Gewinn). Darunter **eine einzige** kleine Zeile mit zwei antippbaren Wörtern: **"▶︎ 3 Minuten Probe"** (startet sofort `dankblitz`, 3 Min — erleben statt glauben, das stärkste Mittel ohne Social Proof) und **"Preise ⌄"**, das eine Glas-Karte aufklappt ("7 Tage gratis testen – ohne Verpflichtung · Danach CHF 3 im Monat oder CHF 25 im Jahr · Jederzeit kündbar, neue Meditationen sind immer dabei" plus **"Alle Einzelheiten ansehen ›"** → Abo-Seite). So steht der Preis offen da (Vertrauen), ohne die ruhige Seite zu belasten: sichtbar erst, wenn jemand danach fragt. Jede weitere Zeile hier unten schiebt die Taste nach oben ins Bild — deshalb sind Probe und Preise zusammengezogen.
...
- **i-Knopf oben rechts** blendet zwei Sätze ein, was oben/unten und links/rechts bedeuten (`#compassInfo`). **Beim allerersten Besuch der Kompass-Seite steht diese Erklärung automatisch offen** (`erklaerungBeimErstenMal()`, Merker `myisland.kompass-erklaert.v1` im localStorage) und lässt sich mit "Verstanden" schliessen; danach kommt sie nie wieder von selbst. Bewusst kein mehrseitiger Einstieg vorweg: Der Kompass selbst fragt schon, wie es der Person geht — ein Fragebogen davor würde dasselbe zweimal fragen.
