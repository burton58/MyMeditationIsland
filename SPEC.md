...
- **Zwei Chat-Instanzen**, beide mit `allowRecommend = true`: unten auf "Mein Weg" und in der Bibliothek (§3.3a). Die dritte auf der Abschluss-Seite ist im Aug. 2026 entfallen (§3.5). Der Begrüssungssatz steht einmal in `BEGLEITER_GRUSS` und wird geteilt, damit beide wörtlich gleich starten.
